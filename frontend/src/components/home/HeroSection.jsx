...
export default function HeroSection() {
  return (
    ...
    >
      ...
      >
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-3 sm:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
          <Link
            to="/signup"
            className="px-6 py-2.5 sm:px-8 sm:py-3 rounded-full bg-gradient-to-r from-white to-white hover:scale-105 text-black transition-transform duration-200 shadow-md text-center text-sm sm:text-base"
          >
            Get Started
          </Link>
          <Link
            to="/login"
            className="px-6 py-2.5 sm:px-8 sm:py-3 rounded-full border border-white hover:bg-white hover:text-black transition text-center text-sm sm:text-base"
          >
            Login
          </Link>
        </div>
